...
import { Building2, Bus, MapPin, Clock, LayoutDashboard, CreditCard, UserCog, Users } from "lucide-react";
...
const allAdminLinks = [
  ...
  { href: "/admin/users", label: "Utilisateurs", icon: Users, platformOnly: true },
